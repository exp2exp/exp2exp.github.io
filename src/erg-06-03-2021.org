...
*** TODO Come back to this during the week                             :ALL:
...
- JC’s discussion with Charlie
  - Charlie is in a very different position from Joe, but they’re both working with students who are likely to get jobs
  - Using the techniques which have been deployed in the Peeragogy project in ERG from the  was a good bet

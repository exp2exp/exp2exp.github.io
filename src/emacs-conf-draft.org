...
* Naive calculation, using Maxima mod                                   :1m:
...
(Actually it’s a bit easier than on the previous naive attempt.)
...
We still want to keep the language around to control fontification etc.
...
4. The stack is work in progress and not just on our part
...
- How to integrate this workflow with Arxana (EmacsConf 2013, FARM 2017)
 ...
 - Ideally feature-complete with BASH... or better yet, LISP
 - ... with a “remote control” for long-running processes?

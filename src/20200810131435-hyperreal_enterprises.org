...
- Also following up on EmacsConf we’ve started an additional weekly seminar, the “[[file:erg.org][Emacs Research Group]]”, which has been quite disciplined about taking notes.

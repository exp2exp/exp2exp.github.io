...
I’m starting to revive Arxana for use in grant applications (targeting
[[file:grant_development.org::*EPSRC: Mathematical Sciences Small Grants][EPSRC: Mathematical Sciences Small Grants]]).  As I go along I want to
...
This particular example should in principle be doable with
[[https://github.com/nobiot/org-transclusion][org-transclusion]], but looking into it a bit more, that’s not actually

...
Re-form groups and run the exercises from Myths ([[myths]]) with a new
Historian. The new Historian should recap key points from the PAR from
Systems to Litany ([[systems-to-litany]]), and the team should then
explore the new scenario, following all of the steps between [[myths]] and
...
Three example issues from Flaws of the Smart City.

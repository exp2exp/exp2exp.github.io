...
\label{sec:orgf0474f9}

\subsection{Preface}
\label{sec:org7cc2734}
...
This document can be thought of and edited as a \hyperref[sec:org5efddcc]{Wiki}, from which other
downstream formats can be derived.  A narrative introduction follows.
To skip it, browse ahead to \hyperref[sec:orge3184bc]{Top}.

\subsection{Introduction}
\label{sec:orgba2dd35}

\subsubsection{Applying AI to technical fields is a huge opportunity.}
\label{sec:org5498a91}
...
\label{sec:orgdbf2bfe}

\subsubsection{PlanetMath}
\label{sec:orgc6d8d89}
...
\label{sec:org46aeccc}
\begin{enumerate}
\item gcp configuration
\label{sec:org008ea1a}
...
\label{sec:org3aa2153}
\begin{enumerate}
\item Setup remote container host machine
\label{sec:org7773fb0}
...
\label{sec:orgdf2845e}
\subsection{Knowledge graph}
\label{sec:org82b9b6f}
...
\label{sec:org33a6609}
\section{Underlying foundation}
\label{sec:org96cc2d2}
...
\label{sec:org52fa7c1}
\subsection{Relationship to purpose}
\label{sec:orgc86c77e}
...
would therefore be a step in the direction of \hyperref[sec:org52fa7c1]{BUSINESS DEVELOPMENT}.

\subsubsection{emacs-jupyter}
\label{sec:orgb1f84d5}
...
\label{sec:orge2d866b}

\subsection{Technology}
\label{sec:org636a4ed}

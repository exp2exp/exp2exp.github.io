...
\label{sec:org7e37306}

\subsection{Preface}
\label{sec:orga0984f2}
...
This document can be thought of and edited as a \hyperref[sec:org3cabf32]{Wiki}, from which other
downstream formats can be derived.  A narrative introduction follows.
To skip it, browse ahead to \hyperref[sec:org26689e2]{Top}.

\subsection{Introduction}
\label{sec:orgc0e1499}

\subsubsection{Applying AI to technical fields is a huge opportunity.}
\label{sec:org8749313}
...
\label{sec:orgbc4643f}

\subsubsection{PlanetMath}
\label{sec:orgac46cf3}
...
\label{sec:org36dce84}
\subsection{Relationship to purpose}
\label{sec:orgc661a94}

...
\label{sec:org46b1cbf}

\subsection{Preface}
\label{sec:orgc34ae79}
...
This document can be thought of and edited as a \hyperref[sec:orgb9d7297]{Wiki}, from which other
downstream formats can be derived.  A narrative introduction follows.
To skip it, browse ahead to \hyperref[sec:org405dbf9]{Top}.

\subsection{Introduction}
\label{sec:org8ff788f}

\subsubsection{Applying AI to technical fields is a huge opportunity.}
\label{sec:org40077fb}
...
\label{sec:orgf20e0dd}

\subsubsection{PlanetMath}
\label{sec:orga3b90cf}
...
\label{sec:org9e54a15}
\begin{enumerate}
\item jupyter
\label{sec:orgf12c748}
The jupyter backend works well locally but suffers from a bug when run via tramp. See \hyperref[sec:orge561d18]{emacs-jupyter remote debugging}

\item ob-streams
\label{sec:org075bf70}

This is work in progress, with some sample content above.
\end{enumerate}

\subsubsection{Future work}
\label{sec:orgf1f0919}
...
\label{sec:org7d9424c}

\begin{enumerate}
\item Calculator example again
\label{sec:orgba2d4cf}
\begin{verbatim}
10+1
\end{verbatim}
...
\label{sec:orgd41416e}
\begin{enumerate}
\item gcp configuration
\label{sec:org799c836}
...
\label{sec:org099846c}
\begin{enumerate}
\item Setup remote container host machine
\label{sec:org0aede8c}
...
\label{sec:org221a989}
\subsection{Knowledge graph}
\label{sec:org57b2012}
...
\label{sec:org5c3607d}
\section{Underlying foundation}
\label{sec:org97639d1}
...
\label{sec:orgd2452db}
\subsection{Relationship to purpose}
\label{sec:org76b3ee9}
...
would therefore be a step in the direction of \hyperref[sec:orgd2452db]{BUSINESS DEVELOPMENT}.

\subsubsection{emacs-jupyter}
\label{sec:org7486826}
...
\label{sec:org4157fa1}

\subsection{Technology}
\label{sec:orgd8a4a3f}

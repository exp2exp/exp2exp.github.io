...
** TODO [#A] Figure out whether it’s possible to get another column in the default Org Agenda, showing the /directory/
...
** TODO [#A] Getting tasks mapped into reasonable packets
** TODO Figure out how to handle tasks that are DONE
** TODO Figure out how to handle tasks that are FROZEN
** TODO Figure out how to handle tasks that are not actually discrete doable tasks but are instead projects :leo:

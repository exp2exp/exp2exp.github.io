...
- While like do tangible deliverables (e.g., journal articles), “If we knew what the outcome was it wouldn’t be research” — and we want to keep a role for serendipity in our work.
#+end_quote
**** Supporting data from CLA 1                                   :noexport:
